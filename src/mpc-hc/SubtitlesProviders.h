...
struct SubtitlesInfo {
    ...
    void Set(SubtitlesProvider* pProvider, BYTE nLanguage, BYTE nHearingImpaired, SHORT nScore) {
        ...
        if (uid == MAXUINT) { uid = ++i; if (uid == MAXUINT) { uid = ++i; } }
